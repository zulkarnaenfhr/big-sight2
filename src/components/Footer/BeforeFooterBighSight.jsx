...
export default class BeforeFooterBighSight extends Component {
  render() {
    return (
      <div
        className="d-flex pb-5 pt-5 flex-sm-row flex-column"
        id="Bighsight-BeforeFooter-section"
        style={{ backgroundColor: "rgba(247, 247, 247, 1)" }}
      >
        <div
          id="Bighsight-section-location"
          className="col-sm-4 col d-flex flex-column justify-content-end align-items-center"
        >
          <img
            className="img-fluid"
            src={require("../../src/Big-Sight/FAQ/LogoBigSight.png")}
            alt=""
            width={300}
            height={170}
          />
        ...
        <div
          ...
          className="col-sm-4 col align-self-sm-end pt-sm-0 pt-4 pb-sm-0 pb-4"
        >
          <section className=" w-75 mx-auto" style={{ height: "220px" }}>
            ...
            <h6 className="pt-sm-5 pt-4">
              Contact Integrated Dashboard Smart Governments
            </h6>
          </section>
        </div>
        <div
          id="Bighsight-section-img"
          className="col-sm-4 col align-self-end text-sm-start text-center"
        >
          <img
            className="img-fluid w-75"
            src={require("../../src/Big-Sight/FAQ/LogoRight.png")}
            alt=""
            width={318}
            height={230}
          />
